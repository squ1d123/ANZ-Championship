...
var svg = d3.select("body")
	...
	var teamlogo = svg.append("svg:image").attr("x",50).attr("y",270).attr("width",500).attr("height",500)
		.attr("xlink:href","images/Southern Steel2.jpg")//.attr("id","home");
	...
	var year13 = svg.append("text").attr("x",980).attr("y",280).style("font-size","33px").text("2013").attr("id","year13").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/steel13.jpg")
	...
	var year12 = svg.append("text").attr("x",1080).attr("y",280).style("font-size","33px").text("2012").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/steel12.jpg")
	...
	var year11 = svg.append("text").attr("x",1180).attr("y",280).style("font-size","33px").text("2011").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/steel11.jpg")
	...
	var year10 = svg.append("text").attr("x",1280).attr("y",280).style("font-size","33px").text("2010").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/steel10.jpg")
	...
	var year09 = svg.append("text").attr("x",1380).attr("y",280).style("font-size","33px").text("2009").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/steel09.jpg")
