...
var svg = d3.select("body")
	...
	var processAll = function(data){
		...
		sortedTeams.sort(compar);
		updateValues(teams, sortedTeams);
	}
	...
	var updateValues = function(teams, sortedTeams){
		...
		var rows = table.rows;
		// console.log(sortedTeams[0].name);
		// rows[1].cells[1].innerHTML = sortedTeams[0].name;
