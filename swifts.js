...
var svg = d3.select("body")
	...
	svg.append("circle").attr("cx",165).attr("cy",120).attr("r",125).attr("fill","blue").style("opacity",0).on("click",function(){
		...
		.attr("xlink:href","images/New South Wales Swifts2.jpg")//.attr("id","home");
	...
	var year13 = svg.append("text").attr("x",980).attr("y",280).style("font-size","33px").text("2013").attr("id","year13").on("mouseover",function () {
					...
					d3.csv("csv/2013-Table1.csv", function (data) {
						var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/swifts13.jpg")
						processAll(data);
	...
	var year12 = svg.append("text").attr("x",1080).attr("y",280).style("font-size","33px").text("2012").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/swifts12.jpg")
	...
	var year11 = svg.append("text").attr("x",1180).attr("y",280).style("font-size","33px").text("2011").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/swifts11.jpg")
	...
	var year10 = svg.append("text").attr("x",1280).attr("y",280).style("font-size","33px").text("2010").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/swifts10.jpg")
	...
	var year09 = svg.append("text").attr("x",1380).attr("y",280).style("font-size","33px").text("2009").on("mouseover",function () {
					...
					var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/swifts09.jpg")
	...
	var year08 = svg.append("text").attr("x",1480).attr("y",280).style("font-size","33px").text("2008").on("mouseover",function () {
				...
				var teamlogo = svg.append("svg:image").attr("x",830).attr("y",100).attr("width",800).attr("height",800).attr("xlink:href","images/rivalry/swifts08.jpg")
